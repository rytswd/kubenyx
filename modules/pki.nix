# Declarative offline PKI (air/v0.1/core/pki.org), generated by the Rust
...
let
  ...
  # Durable posture (air/v0.1/quorum/durable-ha.org §3, Decision 2): a persistent
  ...
  # (air/v0.1/quorum/quorum-mesh.org §D2) — so the gate below widens beyond the
